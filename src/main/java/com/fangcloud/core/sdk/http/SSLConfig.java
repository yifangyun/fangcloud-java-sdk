package com.fangcloud.core.sdk.http;
...
/**
 * The proper SSL configuration that should be used when connecting to Fangcloud
...
public class SSLConfig {
    ...
    // TODO: 17/2/13 这些cipher可能要改
    // All client ciphersuites allowed by Fangcloud.
    //
